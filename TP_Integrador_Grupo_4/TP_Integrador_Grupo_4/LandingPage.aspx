        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" style="height: 500px">
                    <img src="imgs/MixFotosJuegos.png" class="d-block w-100" alt="..." />
        ...
        <section class="container-fluid px-0">
            <div class="row align-items-center content margen">
                <div class="col-md-6 order-2 order-md-2">
                    <img src="imgs/MixFotosJuegos.png" alt="" class="img-fluid" />
                </div>
            ...
            <div class="row align-items-center content margen">
                ...
                <div class="col-md-6 order-2 order-md-1">
                    <img src="imgs/COD_4S.jpg" alt="" class="img-fluid" />
                </div>
            </div>
            <div class="row align-items-center content margen">
                <div class="col-md-6 order-2 order-md-2">
                    <a title="Redireccion" href="http://www.facebook.com">
                        <img src="imgs/RazerPerifericos.png" alt="Redireccion" class="img-fluid" />
                    </a>
                </div>
                <div class="col-md-6 text-center order-1 order-md-1">
                    <div class="row justify-content-center">
