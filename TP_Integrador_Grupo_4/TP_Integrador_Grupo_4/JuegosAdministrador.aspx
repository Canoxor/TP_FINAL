<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JuegosAdministrador.aspx.cs" Inherits="TP_Integrador_Grupo_4.JuegosAdministrador" %>
        ...
        <table class="w-100">
            <tr>
                ...
                <td style="width:34%; text-align:center">
                    <asp:GridView ID="gvJuegos" runat="server" style="position:center">
                    </asp:GridView>
                </td>
                <td style="width:33%">&nbsp;</td>
            </tr>
