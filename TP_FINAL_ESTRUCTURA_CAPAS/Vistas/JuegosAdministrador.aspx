...
<body>
    <form id="formJuegosAdministrador" runat="server">
        ...
        <br />
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PARCIAL_LAB_3_Version_10ConnectionString2 %>" SelectCommand="Select * from Juegos inner join PEGI on J_Codigo_PEGI = PG_Codigo_PEGI inner join Generos on J_Codigo_Genero = G_Codigo_Genero"></asp:SqlDataSource>
