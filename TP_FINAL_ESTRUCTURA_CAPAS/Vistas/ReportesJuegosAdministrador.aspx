...
<body>
    <form id="formLandingPageAdministrador" runat="server">
        ...
        <table class="w-100"  style="background-color:ThreeDDarkShadow">
            <tr>
                <td class="text-center"><strong class="auto-style37"><span class="auto-style38">&nbsp;</span></strong><span class="auto-style22"><strong>Reporte de juegos</strong></span></td>
            </tr>
        </table>
        <br />
        <table class="auto-style14">
            <tr>
                <td class="auto-style39">Consultar el estado del stock de todos los juegos</td>
            </tr>
            <tr>
...
&nbsp;&nbsp;
        ...
        <table class="auto-style14">
            <tr>
                <td class="auto-style15"><strong>Calcular el porcentaje de venta de un determinado juego</strong></td>
            </tr>
            <tr>
...
&nbsp;<b><br class="auto-style7" />
                    ...
                    <span class="auto-style7">Codigo del juego:&nbsp; </span></b>
                    <asp:TextBox ID="txt_CodigoJuego" runat="server" TextMode="Number" CssClass="auto-style41" Width="94px"></asp:TextBox>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br />
                    <br />
                    <strong>
